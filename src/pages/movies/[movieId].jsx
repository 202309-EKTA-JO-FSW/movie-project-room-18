...
console.log(movieDetails);
    return(
      ...
      <p className="mr-2">{movieDetails!= undefined && movieDetails.productionCompany!=undefined ? movieDetails.productionCompany[0].name:"" }</p>
      <img src={`https://image.tmdb.org/t/p/original/${movieDetails!= undefined && movieDetails.productionCompany!=undefined ? movieDetails.productionCompany[0].logo_path :""}`}
      className="h-8"
